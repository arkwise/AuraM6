/*!\file w32_ndis.h
 *
 * Previously named ntddndis.h. But that caused problems when
 * '-I.' is part of CFLAGS (caused this file to shaddow the system
 * <ntddndis.h>).
 *
 *++ BUILD Version: 0001
 ...
 *--
 *
 * Some OIDs also taken from WireShark.
 */
...
#define OID_GEN_CO_GET_NETCARD_TIME             0x00020210
...
/*
 * Copied and adapted from WiresShark:
 */
