...
void CommandExit() {
                return false; //our 'exit' command seems to just return false, you might not need this.
}
...
void CommandLsPci() {
    // ... (Your LSPCI command implementation goes here) ...
}
...
// Add more Command functions as necessary
